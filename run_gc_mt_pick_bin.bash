...
description="${reward_type} ${reward_case} reward，alpha${alpha}，beta${beta_scale}，time_limit ${time_limit}，interval ${sparse_interval}, fb_train ${fb_train_until}, crop ${crop}，video: ${video_name}"
